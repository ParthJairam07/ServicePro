...
fun UISignUpPage(navController: NavHostController) {
            ...
            view = object : SignUpView {
                ...
                override fun onSignUpSuccess() {
                    navController.navigate("create_pin") {
                        // Clear back stack to prevent user from going back to sign up screen
    ...
    //Launcher for the google sign up
    val launcher = rememberLauncherForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK) {
            ...
            try {
                // Google Sign In was successful, get the token and pass to presenter
                val account = task.getResult(ApiException::class.java)!!
                val idToken = account.idToken!!
                presenter.onGoogleSignInSucceeded(idToken)
            } catch (e: ApiException) {
                // Google Sign In failed
                presenter.view.showError("Google Sign-In failed: ${e.statusCode}")
            }
        }
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            // Visual Divider and Google Sign-Up Option
...
@Composable
fun ExitButton(modifier: Modifier = Modifier, navController: NavHostController) {
    FloatingActionButton(
        onClick = { navController.popBackStack() }, // Navigates to the previous screen
        modifier = modifier,
...
fun EmailInput(email: String, onEmailChange: (String) -> Unit) {
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.padding(start = 22.dp, 10.dp).padding(bottom = 40.dp).fillMaxWidth(),
...
fun PasswordInput(password: String, onPasswordChange: (String) -> Unit) {
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.padding(start = 22.dp, 10.dp).padding(bottom = 10.dp).fillMaxWidth(),
    ...
    Column(
        ...
        Column(
            ...
            Button(
                ...
                enabled = selectedOption1 && email.isNotEmpty() && password.isNotEmpty(),
